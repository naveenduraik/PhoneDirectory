...
public class Address {
	...
	/*
	 * public Address(int addressId, String t_doorNo, String t_streetName, String
	 * t_city, String t_pinCode, String t_state, String t_country, String p_doorNo,
	 * String p_streetName, String p_city, String p_pinCode, String p_state, String
	 * p_country,int userId) { super(); this.addressId = addressId; this.t_doorNo =
	 * t_doorNo; this.t_streetName = t_streetName; this.t_city = t_city;
	 * this.t_pinCode = t_pinCode; this.t_state = t_state; this.t_country =
	 * t_country;
	 * 
	 * this.p_doorNo = p_doorNo; this.p_streetName = p_streetName; this.p_city =
	 * p_city; this.p_pinCode = p_pinCode; this.p_state = p_state; this.p_country =
	 * p_country; this.userId = userId; }
	 */
	
	public Address(String t_doorNo, String t_streetName, String t_city, String t_pinCode, String t_state,
